...
from xumes.game_module.implementations.events_impl.windows_events import Up, Down, Left, Right, Space, KeyA, KeyB, KeyC, \
...
class WindowsEventFactory(EventFactory):
