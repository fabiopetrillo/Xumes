...
from framework.src.game_service_module.i_communication_service_game import ICommunicationServiceGame
...
from framework.src.game_service_module.test_runner import _TestRunner
