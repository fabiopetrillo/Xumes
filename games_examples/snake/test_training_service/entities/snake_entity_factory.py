...
from games_examples.snake.test_training_service.entities.fruit_entity import FruitEntity
from games_examples.snake.test_training_service.entities.snake_entity import SnakeEntity
